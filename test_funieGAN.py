...
import cv2
vidcap = cv2.VideoCapture("data/Videos/underwater5.mp4")
success, image = vidcap.read()
count = 1
while success:
  cv2.imwrite("data/Videos/underwater5/%d.jpg" % count, image)
  success, image = vidcap.read()
  print('Saved image ', count)
  count += 1

## for testing arbitrary local data
data_dir = "data/Videos/underwater5/"
...
print(funie_gan_generator.summary())
print(model_h5)
